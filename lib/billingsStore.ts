...
export let mockBillingTypes: BillingTypeRecord[] = [
  // Admin 2 (Sunrise Properties)
  {
    ...
    admin_id: 2,
    name: 'Monthly Rent',
    description: 'Standard residential unit rental fee',
  ...
  },
  {
    ...
    admin_id: 2,
    name: 'Water & Utility',
    description: 'Monthly submetered water consumption statement',
  ...
  },
  {
    ...
    description: 'Electric submeter consumption charge',
    due_date_type: 'days_after_posting',
    due_date_value: 10,
  ...
  },
  {
    ...
    description: 'Dedicated vehicle basement parking space slot',
    due_date_type: 'fixed_day',
    due_date_value: 1,
    late_fee_type: 'fixed',
  ...
  // Admin 3 (Greenview Residences)
  {
    ...
    admin_id: 3,
    name: 'Monthly Rent',
    description: 'Greenview residential rent',
    due_date_type: 'fixed_day',
    due_date_value: 1,
    late_fee_type: 'fixed',
  ...
  },
  {
    ...
    description: 'Monthly building dues',
    due_date_type: 'days_after_posting',
    due_date_value: 10,
    late_fee_type: 'percentage',
    late_fee_amount: 2.0,
...
export let mockBillings: BillingRecord[] = [
  // Admin 2 (Sunrise Properties)
  {
    ...
    due_date: '2026-08-01',
    status: 'overdue',
    late_fee_applied: 500.00,
    created_at: '2026-07-25',
    billing_type_name: 'Monthly Rent',
    tenant_name: 'Juan Dela Cruz',
    tenant_email: 'juan.delacruz@email.com',
  ...
  },
  {
    ...
    meter_readings_json: {
      water: { previous: 420, current: 465, consumption: 45, rate_per_unit: 45.00, amount: 2025.00 }
    },
    created_at: '2026-08-01',
    billing_type_name: 'Water & Utility',
    tenant_name: 'Maria Santos',
    tenant_email: 'maria.santos@email.com',
  ...
  },
  {
    ...
    late_fee_applied: 0.00,
    meter_readings_json: {
      electricity: { previous: 1050, current: 1250, consumption: 200, rate_per_unit: 12.50, amount: 2500.00 }
    },
    created_at: '2026-08-10',
    billing_type_name: 'Electricity Utility',
    tenant_name: 'Juan Dela Cruz',
    tenant_email: 'juan.delacruz@email.com',
    unit_number: 'Unit 101',
    building_name: 'Sunrise Apartments',
  ...
  // Admin 3 (Greenview Residences)
  {
    ...
    billing_type_name: 'Monthly Rent',
    tenant_name: 'Pedro Reyes',
    tenant_email: 'pedro.reyes@email.com',
    unit_number: 'Unit 101',
...
export const mockTenantsUnits = [
  // Admin 2
  { admin_id: 2, tenant_id: 1, tenant_name: 'Juan Dela Cruz', tenant_email: 'juan.delacruz@email.com', unit_id: 101, unit_number: 'Unit 101', building_name: 'Sunrise Apartments' },
  { admin_id: 2, tenant_id: 2, tenant_name: 'Maria Santos', tenant_email: 'maria.santos@email.com', unit_id: 102, unit_number: 'Unit 102', building_name: 'Sunrise Apartments' },
  // Admin 3
  { admin_id: 3, tenant_id: 3, tenant_name: 'Pedro Reyes', tenant_email: 'pedro.reyes@email.com', unit_id: 201, unit_number: 'Unit 101', building_name: 'Greenview Residences' },
  { admin_id: 3, tenant_id: 4, tenant_name: 'Ana Lim', tenant_email: 'ana.lim@email.com', unit_id: 202, unit_number: 'Unit 102', building_name: 'Greenview Residences' }
];
