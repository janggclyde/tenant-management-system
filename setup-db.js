...
const indexTs = `import { Sequelize, DataTypes } from "sequelize";
...
`;
fs.writeFileSync(path.join(modelsDir, 'index.ts'), indexTs);

console.log('Database setup files generated.');
